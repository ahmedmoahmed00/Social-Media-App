...
function Modal({ children, onClose }) {
  ...
  return (
    <div>
      ...
      <div
        ref={ref}
        className="flex flex-col z-100 gap-4 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-primary dark:bg-dark-primary p-4 w-[95%] max-w-2xl rounded-lg"
      >
